package com.mySpring.demo.AMQP.Consumer;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.mySpring.demo.AMQP.MessageDto;
...
public class MessageConsumer {
    ...
    public static <T> T parse(String json, Class<T> clazz) throws IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
        try {
